...
public:
  StatisticalOutlierRemoval(int meanK, double stddevMulThresh) : meanK_(meanK), stddevMulThresh_(stddevMulThresh)
  {
  }
...
public:
  CropBoxFilter(const Eigen::Vector4f& minPoint, const Eigen::Vector4f& maxPoint)
